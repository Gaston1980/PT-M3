...
//TODA LA HOMEWORK HECHA EN Función constructora:
function $Promise(executor) {
    ...
    //Internamente en algún momento llama al resolve ó reject para cambiar el estado de la promesa
